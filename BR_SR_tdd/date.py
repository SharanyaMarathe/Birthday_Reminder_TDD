...
def months_display(B_day,C_day):
...
def Notification(B_day,C_day):
	if(B_day.month > C_day.month):
		return months_display(B_day,C_day) 
...
def Date_info(date,date_birth):
	...
	return ("Birthday : ",Current_date[0]," ",Current_date[1]," ",Birthday_notify,"  ||  ","On ",Birth_day[0],", ",Birth_day[1].day,"th of",Birth_day[2])
